    ...
    return (
        <div className="max-w-7xl mx-auto mt-16 flex flex-col lg:flex-row gap-10">
            <div className='lg:w-1/3 flex flex-col gap-9'>
                <div className='p-6 shadow-lg shadow-black'>
                ...
                <div className='flex-grow shadow-lg shadow-black p-6'>
                    <p className='text-xl'>Download My Resume:</p>
                    <p className='mt-8 flex gap-4'>
                        <a href="https://drive.google.com/file/d/1wIiOr21qmesj8UPa4azHDlt1Wcmt3aZJ/view?usp=sharing" target='_blank' rel="noreferrer"><button className='uppercase font-semibold border-sky-600 border-2 text-sky-600 px-5 py-4 hover:border-none hover:bg-sky-600 hover:text-white'>Download Resume</button></a>
            ...
            <div className='flex-1 flex justify-end items-center p-9 shadow-lg shadow-black'>
